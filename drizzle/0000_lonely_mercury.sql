...
CREATE TABLE "wishlist" (
	...
	CONSTRAINT "wishlist_slug_unique" UNIQUE("slug")
);
--> statement-breakpoint
...
ALTER TABLE "wishlist_item" ADD CONSTRAINT "wishlist_item_claimedByUserId_user_id_fk" FOREIGN KEY ("claimedByUserId") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
